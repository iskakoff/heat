...
def main():
    ...
    parser.add_argument("--Cp", default=4180.0, type=float, help="heat_transfer capacity")
    parser.add_argument("--rho", default=1000.0, type=float, help="density")
    ...
    parser.add_argument("--dt", default=1, type=float, help="discretization time")
    ...
    solar = Solar(**v)
    pipe_1 = Pipe(length=0.3, u=5000, n=20, **v)
    pipe_2 = Pipe(length=0.3, u=5000, n=20, **v)
